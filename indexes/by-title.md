...
- **A Multi-Agent System for Autonomous, Fine-Tuning-Free Clinical Symptom Detection: Development and Validation Study** — *Unknown* · **2026**
...
- **An autonomous agentic workflow for clinical detection of cognitive concerns using large language models** — *Unknown* · **2026**
...
- **An Infectious Disease Spread Simulation Based on Large Language Model Decision Making** — *Unknown* · **2026**
...
- **Baichuan-M4: A Clinical-Grade Medical Agent System for Continuous Care** — *Unknown* · **2026**
  [[📝 Paper](https://arxiv.org/abs/2606.08982)]

- **Better with Experience: Self-Evolving LLM Agents for Evidence-Grounded Health Community Notes (EvoNote)** — *Unknown* · **2026**
...
- **ClinicalReTrial: Clinical Trial Redesign with Self-Evolving Agents** — *Unknown* · **2026**
...
- **Closed-Loop Quality Assurance for Production Clinical AI Documentation** — *Unknown* · **2026**
...
- **D2MDT: Department-aware Multidisciplinary Team Consultation with Deliberation for Efficient Clinical Prediction** — *Unknown* · **2026**
...
- **FedEHR-Agents: Federated Agentic Optimization for Automated EHR Modeling** — *Unknown* · **2026**
...
- **HealthFlow: automating electronic health record analysis via a strategically self-evolving multi-agent framework** — *Unknown* · **2025**
...
- **Human-AI co-design for clinical prediction models (HACHI)** — *Unknown* · **2026**
...
- **Learning to Be A Doctor: Searching for Effective Medical Agent Architectures** — *Unknown* · **2025**
...
- **MARLA: An Autonomous Agent for Medical AI Research and Development** — *Unknown* · **2026**
...
- **MDTeamGPT: Mitigating Context Collapse and Enabling Self-Evolution in Medical Multi-Agent Reasoning** — *Unknown* · **2025**
...
- **MedClaw: Heuristic Agent Harness for Long-Horizon Surgical Video Reasoning** — *Unknown* · **2026**
...
- **MediSkill-Evo: Process-Constrained Self-Evolution for Evidence-Grounded Clinical Interaction** — *Unknown* · **2026**
...
- **MeDxAgent: Multi-Agent Consultation for Interactive Medical Diagnosis** — *Unknown* · **2026**
...
- **OPERA: Offline Policy-guided Expert Routing and Adaptation for Universal Biomedical Image Analysis** — *Unknown* · **2026**
...
- **Probe Before You Edit: Probing-Guided Molecular Optimization for LLM Agents in Structure-Based Drug Design** — *Unknown* · **2026**
...
- **SafeRx-Agent: A Knowledge-Grounded Multi-Agent Framework for Safe and Explainable Medication Recommendation** — *Unknown* · **2026**
...
- **Towards Fully Automated Medical Imaging Code Generation via Validation-based Context Engineering** — *Unknown* · **2026**
